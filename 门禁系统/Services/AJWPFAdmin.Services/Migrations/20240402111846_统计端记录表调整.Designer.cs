...
namespace AJWPFAdmin.Services.Migrations
{
    ...
    [Migration("20240402111846_统计端记录表调整")]
    partial class 统计端记录表调整
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AJWPFAdmin.Services.EF.Tables.CarType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 480306L,
                            AutoPass = true,
                            CreateDate = new DateTime(2024, 4, 2, 19, 18, 46, 634, DateTimeKind.Local).AddTicks(675),
            ...
            modelBuilder.Entity("AJWPFAdmin.Services.EF.Tables.PlatformCustomer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Enable = true,
                            ExpireDate = new DateTime(2025, 4, 2, 19, 18, 46, 634, DateTimeKind.Local).AddTicks(675),
                            Name = "阿吉"
                        });
                });
            ...
            modelBuilder.Entity("AJWPFAdmin.Services.EF.Tables.SystemRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PId = 480306,
                            Permission = "all",
                            UpdateDate = new DateTime(2024, 4, 2, 19, 18, 46, 634, DateTimeKind.Local).AddTicks(675)
                        });
                });
            ...
            modelBuilder.Entity("AJWPFAdmin.Services.EF.Tables.WarehousePassageRecord", b =>
                {
                    ...
                    b.Property<string>("CameraCaptureFile")
                        .HasColumnType("longtext")
                        .HasComment("监控抓拍图文件路径");
                    ...
                    b.Property<string>("IdentifiedCaptureFullFile")
                        .HasColumnType("longtext")
                        .HasComment("车牌识别抓拍全图文件路径");

                    b.Property<string>("IdentifiedCaptureSmallFile")
                        .HasColumnType("longtext")
                        .HasComment("车牌识别抓拍图文件路径");
