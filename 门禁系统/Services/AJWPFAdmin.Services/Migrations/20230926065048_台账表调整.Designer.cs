...
namespace AJWPFAdmin.Services.Migrations
{
    ...
    [Migration("20230926065048_台账表调整")]
    partial class 台账表调整
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AJWPFAdmin.Services.EF.Tables.CarType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 480306L,
                            AutoPass = true,
                            CreateDate = new DateTime(2023, 9, 26, 14, 50, 48, 24, DateTimeKind.Local).AddTicks(9027),
                            Name = "固定车",
                            PId = 480306,
                            SysRequired = true
                        },
            ...
            modelBuilder.Entity("AJWPFAdmin.Services.EF.Tables.PlatformCustomer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Enable = true,
                            ExpireDate = new DateTime(2024, 9, 26, 14, 50, 48, 24, DateTimeKind.Local).AddTicks(9027),
                            Name = "阿吉"
                        });
                });
            ...
            modelBuilder.Entity("AJWPFAdmin.Services.EF.Tables.SystemRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PId = 480306,
                            Permission = "all",
                            UpdateDate = new DateTime(2023, 9, 26, 14, 50, 48, 24, DateTimeKind.Local).AddTicks(9027)
                        });
                });
