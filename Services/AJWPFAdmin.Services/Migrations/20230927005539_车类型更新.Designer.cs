...
namespace AJWPFAdmin.Services.Migrations
{
    ...
    [Migration("20230927005539_车类型更新")]
    partial class 车类型更新
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AJWPFAdmin.Services.EF.Tables.CarType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 480306L,
                            AutoPass = true,
                            CreateDate = new DateTime(2023, 9, 27, 8, 55, 38, 941, DateTimeKind.Local).AddTicks(7312),
            ...
            modelBuilder.Entity("AJWPFAdmin.Services.EF.Tables.PlatformCustomer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Enable = true,
                            ExpireDate = new DateTime(2024, 9, 27, 8, 55, 38, 941, DateTimeKind.Local).AddTicks(7312),
                            Name = "阿吉"
                        });
                });
            ...
            modelBuilder.Entity("AJWPFAdmin.Services.EF.Tables.SystemRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PId = 480306,
                            Permission = "all",
                            UpdateDate = new DateTime(2023, 9, 27, 8, 55, 38, 941, DateTimeKind.Local).AddTicks(7312)
                        });
                });
