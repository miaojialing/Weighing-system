...
namespace AJWPFAdmin.Services.Migrations
{
    ...
    [Migration("20230925084639_仓库表更新")]
    partial class 仓库表更新
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AJWPFAdmin.Services.EF.Tables.CarType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 480306L,
                            AutoPass = true,
                            CreateDate = new DateTime(2023, 9, 25, 16, 46, 39, 574, DateTimeKind.Local).AddTicks(8065),
                            Name = "固定车",
                            PId = 480306,
                            SysRequired = true
                        },
            ...
            modelBuilder.Entity("AJWPFAdmin.Services.EF.Tables.Passageway", b =>
                {
                    ...
                    b.Property<bool>("TemporaryVehicleAccess")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("AJWPFAdmin.Services.EF.Tables.PlatformCustomer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Enable = true,
                            ExpireDate = new DateTime(2024, 9, 25, 16, 46, 39, 574, DateTimeKind.Local).AddTicks(8065),
                            Name = "阿吉"
                        });
                });
            ...
            modelBuilder.Entity("AJWPFAdmin.Services.EF.Tables.SystemRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PId = 480306,
                            Permission = "all",
                            UpdateDate = new DateTime(2023, 9, 25, 16, 46, 39, 574, DateTimeKind.Local).AddTicks(8065)
                        });
                });
